			...
			<div id="content">
				...
				<div id="inner-content" class="container section row">
						...
						<div id="main" class="col eight mobile-full" role="main">
							...
							<h1 class="archive-title h2"><span><?php _e( 'Posts Categorized:', 'smashingtheme' ); ?></span> <?php single_cat_title(); ?></h1>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'section' ); ?> role="article">
								...
								<header class="article-header">
									...
									<p class="byline vcard"><?php
										printf( __( 'Posted <time class="updated" datetime="%1$s" pubdate>%2$s</time> by <span class="author">%3$s</span> <span class="amp">&</span> filed under %4$s.', 'smashingtheme' ), get_the_time( 'Y-m-j' ), get_the_time( __( 'F jS, Y', 'smashingtheme' )), smashing_get_the_author_posts_link(), get_the_term_list( get_the_ID(), 'custom_cat', "" ) );
									?></p>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry section">
										...
										<footer class="article-footer">
												<p><?php _e( 'This is the error message in the taxonomy-custom_cat.php template.', 'smashingtheme' ); ?></p>
										</footer>
									</article>
