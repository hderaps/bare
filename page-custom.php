						...
						<div id="main" class="col eight mobile-full" role="main">
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
								...
								<footer class="article-footer">
									<p class="clearfix"><?php the_tags( '<span class="tags">' . __( 'Tags:', 'smashingtheme' ) . '</span> ', ', ', '' ); ?></p>
								</footer>
							...
							<?php endwhile; else : ?>
									<article id="post-not-found" class="hentry section">
										...
										<footer class="article-footer">
												<p><?php _e( 'This is the error message in the page-custom.php template.', 'smashingtheme' ); ?></p>
										</footer>
									</article>
							<?php endif; ?>
						</div>
